			...
			<g transform="matrix(1,0,0,1,-713.419,-878.793)">
				<g id="body" transform="matrix(4.16667,0,0,4.16667,0,0)">
					<g transform="matrix(1,0,0,1,371.053,216.935)">
						<path class="gly-body" d="M0,647.047C-11.004,647.047 -21.258,641.127 -26.76,631.598L-195.707,338.973C-201.208,329.443 -201.208,317.604 -195.707,308.074L-26.76,15.449C-21.257,5.92 -11.004,0 0,0L337.894,0C348.897,0 359.151,5.92 364.654,15.449L533.6,308.074C539.102,317.604 539.102,329.443 533.6,338.973L364.654,631.598C359.151,641.127 348.898,647.047 337.894,647.047L0,647.047Z" style="fill-rule:nonzero;"/>
					</g>
				</g>
	...
	function addInitials() {
		...
		const initials = TextCollection(
			...
			[
				ShapeStyle("class", "gly_text", true),
				ShapeStyle("class", "dark", true),
				ShapeStyle("font-size", "440px", true),
				ShapeStyle("class", "gly_gray_fill.lighten", !!placeholder),
			]
		);
		...
		const largeInitials = TextCollection(
			...
			[
				ShapeStyle("class", "gly_text", true),
				ShapeStyle("class", "dark", true),
				ShapeStyle("font-size", "680px", true),
				ShapeStyle("class", "gly_gray_fill.lighten", !!placeholder),
			]
		);
